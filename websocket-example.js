...
var WebSocketConnection = function(req, socket, upgradeHead) {
    ...
    socket.on('data', function(buf){
       ...
       while(self._processBuffer()) {
           //TODO: process buffer while it contains complete frames
       }
    });
...
WebSocketConnection.prototype._processBuffer = function() {
    ...
    var idx = 2;
    var b1 = buf.readUInt8(0);// from 0 read 8 bit(first byte)
    var fin = b1 & 0x80; //0x80: 1000 0000
    var opcode = b1 & 0x0f; // 0x0f: 0000 1111
    var b2 = buf.readUInt8(1);//read second byte
    var mask = b2 & 0x80;  //1000 0000
    var length = b2 & 0x7f; //0111 1111
...
var unmask = function(maskBytes, data) {
    ...
    for(var i = 0; i < data.length; i++){
        ...
        //0101 ^ 1100 = 1001 当且仅当只有一个表达式的某位上为 1 时，结果的该位才为 1。否则结果的该位为 0。
    }
    return payload;
}
